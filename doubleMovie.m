...
for i = 1:nframes
    ...
    subplot(4, 1, 1);
    surf(x_4d(:, :, 1), y_4d(:, :, 1), phase_sampled(:, :, i), 'EdgeColor', 'none'); 
    view(2);
    colormap jet;
    axis tight;
    ...
    subplot(4, 1, 2);
    surf(x_4d(:, :, 1), y_4d(:, :, 1), mean_OPD_phi_copy(:, :, i), 'EdgeColor', 'none'); 
    view(2);
    colormap jet;
    axis tight;
    caxis([min(min(phase_Final_new(:, :, 33))) max(max(phase_Final_new(:, :, 33)))]);
    ...
    subplot(4, 1, 3);
    surf(x_4d(:, :, 1), y_4d(:, :, 1), var_OPD_phi_copy(:, :, i), 'EdgeColor', 'none');
    view(2);
    colormap jet;
    axis tight;
    ...
    subplot(4, 1, 4);
    surf(x_4d(:, :, 1), y_4d(:, :, 1), mean_removed_phase(:, :, i), 'EdgeColor', 'none'); 
    view(2);
    colormap jet;
    axis tight;
    caxis([min(min(phase_Final_new(:, :, 33))) max(max(phase_Final_new(:, :, 33)))]);
